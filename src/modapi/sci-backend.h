 ...
 * @param name a name of the backend in question. it is expected that this string have static lifetime.
 ...
 */
int sci_plugin_register(const char* name, DocumentMeta** (*fill_meta_in)(const DocumentMeta*, size_t*, size_t, void*),
